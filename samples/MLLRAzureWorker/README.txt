...
* When "Publish", VS always tries to build the AnyCPU flavor instead of "x64". If the proj file does not contain "AnyCPU", 
  the build will fail. However, Prajna's DLLs only target to x64. To workaround, 
  <PlatformTarget>x64</PlatformTarget>
  is put to the AnyCPU too. 
